...
if __name__ == "__main__":
    ...
    # Define all channels
    channels = {
        "Manu Arora": "UC7MQDjVfjEPkHMe1lZGkDRA",
        "ThePrimeTimeagen": "UCUyeluBRhGPCW4rPe_UvBZQ",
    ...
    for channel_name, channel_id in channels.items():
        ...
        print(f"{'='*60}")
        channel_videos: List[ChannelVideo] = scraper.scrape_channel(channel_id, hours=200)
